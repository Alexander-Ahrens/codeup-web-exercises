...
var messages = confirm("Would you like to enter a number?")
var messages2 = prompt("What number do you choose?")

function isOdd(someNum) {
    if (someNum % 2 === 1) {
        alert("Cool! This number is odd!")
        return "Cool! This number is odd!"
    } else if ( someNum % 3 === 1) {
        alert("Sweet! This number is even!")
        return"Sweet! This number is even!"
    }
}
...
function addOneHunnid(numPlusOneHundred) {
    ...
    return "If you add 100 to this number, it is " + numPlusOneHundred +  ". :)"
}

function positiveOrNegative(someNum) {
    if (someNum > 0) {
        alert("The number is positive! Just like your attitude!")
        return "The number is positive! Just like your attitude!"
    }
    else if (someNum < 0) {
        alert("The number is negative. The the creepy photography setting...")
        return "The number is negative. The the creepy photography setting..."
    }
}
